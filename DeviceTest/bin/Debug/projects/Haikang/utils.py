...
def JoinChar(content,char,percount):
    pattenText = '.{%d}' %  percount
    pattern = re.compile(pattenText)
    return char.join(pattern.findall(content))


if __name__ == '__main__':
    print JoinChar("1234567890",':',2)